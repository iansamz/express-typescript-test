/*!
 * Otherside Redo
 * Copyright 2017-2020 Otherside LTD (undefined)
 */
(function(global, factory) {
  ...
  jQuery$1 =
    jQuery$1 && jQuery$1.hasOwnProperty("default")
      ? jQuery$1["default"]
      : jQuery$1;
  scrollMonitor =
    scrollMonitor && scrollMonitor.hasOwnProperty("default")
      ? scrollMonitor["default"]
      : scrollMonitor;
  Flickity =
    Flickity && Flickity.hasOwnProperty("default")
      ? Flickity["default"]
      : Flickity;
  Isotope$1 =
    Isotope$1 && Isotope$1.hasOwnProperty("default")
      ? Isotope$1["default"]
      : Isotope$1;
  jarallax$1 =
    jarallax$1 && jarallax$1.hasOwnProperty("default")
      ? jarallax$1["default"]
      : jarallax$1;
  Plyr = Plyr && Plyr.hasOwnProperty("default") ? Plyr["default"] : Plyr;
  Prism = Prism && Prism.hasOwnProperty("default") ? Prism["default"] : Prism;
  SmoothScroll =
    SmoothScroll && SmoothScroll.hasOwnProperty("default")
      ? SmoothScroll["default"]
      : SmoothScroll;
  twitterFetcher =
    twitterFetcher && twitterFetcher.hasOwnProperty("default")
      ? twitterFetcher["default"]
      : twitterFetcher;
    ...
    var Countdown =
      ...
      (function() {
        function Countdown(element) {
          ...
          this.fallback =
            $element.attr(Selector.DATE_FALLBACK_ATTR) || Default.ELAPSED; // Options for detailed mode

          this.detailed =
            this.element.getAttribute("data-" + Options.DETAILED) !== null;
          ...
          if (this.detailed) {
            this.years = {
              ...
              format:
                $element.find(Selector.Y_EL).data(Options.FORMAT) ||
                Default.Y_FMT,
              label: {
                show: $element.find(Selector.Y_LABEL_EL).length,
                element: $element.find(Selector.Y_LABEL_EL),
                format:
                  $element.find(Selector.Y_LABEL_EL).data(Options.FORMAT) ||
                  Default.Y_LABEL_FMT
              }
            };
            this.months = {
              ...
              format:
                $element.find(Selector.MTHS_EL).data(Options.FORMAT) ||
                Default.MTHS_FMT,
              label: {
                show: $element.find(Selector.MTHS_LABEL_EL).length,
                element: $element.find(Selector.MTHS_LABEL_EL),
                format:
                  $element.find(Selector.MTHS_LABEL_EL).data(Options.FORMAT) ||
            ...
            this.weeks = {
              ...
              format:
                $element.find(Selector.W_EL).data(Options.FORMAT) ||
                Default.W_FMT,
              label: {
                show: $element.find(Selector.W_LABEL_EL).length,
                element: $element.find(Selector.W_LABEL_EL),
                format:
                  $element.find(Selector.W_LABEL_EL).data(Options.FORMAT) ||
                  Default.W_LABEL_FMT
              }
            };
            this.days = {
              ...
              format:
                $element.find(Selector.D_EL).data(Options.FORMAT) ||
                Default.D_FMT,
              label: {
                show: $element.find(Selector.D_LABEL_EL).length,
                element: $element.find(Selector.D_LABEL_EL),
                format:
                  $element.find(Selector.D_LABEL_EL).data(Options.FORMAT) ||
                  Default.D_LABEL_FMT
              }
            };
            this.hours = {
              ...
              format:
                $element.find(Selector.H_EL).data(Options.FORMAT) ||
                Default.H_FMT,
              label: {
                show: $element.find(Selector.H_LABEL_EL).length,
                element: $element.find(Selector.H_LABEL_EL),
                format:
                  $element.find(Selector.H_LABEL_EL).data(Options.FORMAT) ||
                  Default.H_LABEL_FMT
              }
            };
            this.minutes = {
              ...
              format:
                $element.find(Selector.MINS_EL).data(Options.FORMAT) ||
                Default.MINS_FMT,
              label: {
                show: $element.find(Selector.MINS_LABEL_EL).length,
                element: $element.find(Selector.MINS_LABEL_EL),
                format:
                  $element.find(Selector.MINS_LABEL_EL).data(Options.FORMAT) ||
                  Default.MINS_LABEL_FMT
              }
            };
            this.seconds = {
              ...
              format:
                $element.find(Selector.S_EL).data(Options.FORMAT) ||
                Default.S_FMT,
              label: {
                show: $element.find(Selector.S_LABEL_EL).length,
                element: $element.find(Selector.S_LABEL_EL),
                format:
                  $element.find(Selector.S_LABEL_EL).data(Options.FORMAT) ||
                  Default.S_LABEL_FMT
              }
            };
          }
            ...
            element.countdown(this.date, function(event) {
              if (!event.elapsed) {
                ...
                if (_this.years.label.show) {
                  _this.years.label.element.text(
                    event.strftime(_this.years.label.format)
                  );
                }

                if (_this.months.show) {
                  _this.months.element.text(
                    event.strftime(_this.months.format)
                  );
                }

                if (_this.months.label.show) {
                  _this.months.label.element.text(
                    event.strftime(_this.months.label.format)
                  );
                }
                ...
                if (_this.weeks.label.show) {
                  _this.weeks.label.element.text(
                    event.strftime(_this.weeks.label.format)
                  );
                }
                ...
                if (_this.days.label.show) {
                  _this.days.label.element.text(
                    event.strftime(_this.days.label.format)
                  );
                }
                ...
                if (_this.hours.label.show) {
                  _this.hours.label.element.text(
                    event.strftime(_this.hours.label.format)
                  );
                }

                if (_this.minutes.show) {
                  _this.minutes.element.text(
                    event.strftime(_this.minutes.format)
                  );
                }

                if (_this.minutes.label.show) {
                  _this.minutes.label.element.text(
                    event.strftime(_this.minutes.label.format)
                  );
                }

                if (_this.seconds.show) {
                  _this.seconds.element.text(
                    event.strftime(_this.seconds.format)
                  );
                }

                if (_this.seconds.label.show) {
                  _this.seconds.label.element.text(
                    event.strftime(_this.seconds.label.format)
                  );
                }
              } else {
  ...
  var mrDropdownGrid = (function($) {
      ...
      (function() {
        ...
        _proto.getOptions = function getOptions() {
          if (!this.options) {
            this.options = {};
            this.options.hover =
              (this.element.getAttribute(Options.HOVER) === "true" ||
        ...
        _proto.positionContent = function positionContent(
          ...
          if (this.content) {
            ...
            var contentRect = mrDropdownGrid.getDimensionsFromElement(
              this.content
            );
            ...
            if (this.isSubmenu) {
              this.getParentMenu();
              var parentContent = mrDropdownGrid.getDimensionsFromElement(
                this.parentMenu.content
              ); // Calculate X Offset

              if (
                parentContent.offsetLeft + parentContent.width + contentWidth <=
                windowWidth
              ) {
        ...
        _proto.getContainerElement = function getContainerElement() {
          if (!this.container) {
            if (this.parent) {
              this.container = this.parent.querySelector(
                "" + Selector.MENU + Selector.CONTAINER
              );
            }
          }
        ...
        _proto.getSiblingMenus = function getSiblingMenus() {
          return $(this.element)
            ...
            .get(0)
            .querySelectorAll(Selector.DATA_TOGGLE);
        };
        ...
        _proto.addEventListeners = function addEventListeners() {
          ...
          if (this.hover) {
            $(this.parent).on(
              Event.MOUSE_ENTER + " " + Event.MOUSE_LEAVE,
              function(event) {
                event.preventDefault();
                event.stopPropagation();

                if (
                  ("" + event.type + EVENT_KEY === Event.MOUSE_ENTER &&
                    _this2.isActive) ||
                  ("" + event.type + EVENT_KEY === Event.MOUSE_LEAVE &&
                    !_this2.isActive)
                ) {
                  return;
                }
        ...
        DropdownGrid.getDimensionsFromElement = function getDimensionsFromElement(
          element
        ) {
          if (element && mrUtil.isElement(element)) {
            var rect = element.getBoundingClientRect();
            rect.offsetLeft = Math.round(
              rect.left +
                window.pageXOffset -
        ...
        DropdownGrid.getParentFromElement = function getParentFromElement(
          element
        ) {
        ...
        DropdownGrid.clearMenus = function clearMenus(event, specificToggle) {
          ...
          mrUtil.forEach(toggles, function(index, toggle) {
            ...
            if (event) {
              if (
                event.type === "click" &&
                ($.contains(context.content, event.target) ||
                  context.content.isSameNode(event.target))
              ) {
                return;
              }
            }
        ...
        DropdownGrid.dataApiKeydownHandler = function dataApiKeydownHandler(
          event
        ) {
    ...
    $(document)
      .on(
        ...
        DropdownGrid.dataApiKeydownHandler
      )
      .on(
        Event.KEYDOWN_DATA_API,
        Selector.MENU,
          ...
          },
          {
            ...
            set: function set(ready) {
              if (ready === true && apiReady === false) {
                mrUtil.forEach(Recaptchav2.instances, function(
                  index,
                  instance
                ) {
                  instance.init();
    ...
    var FormEmail =
      ...
      (function() {
        function FormEmail(element) {
          this.form = element;
          this.action =
            this.form.getAttribute(Attribute.ACTION) || Default.FORM_ACTION; // Returns an object containing the feedback
        ...
        _proto.initSubmitButton = function initSubmitButton() {
          ...
          this.submitButtonSpan = this.submitButton.querySelector(
            Selector.SPAN
          );
          this.loadingText =
        ...
        _proto.processResponse = function processResponse(response) {
          ...
          var successRedirect = this.form.getAttribute(
        ...
        _proto.getFeedbackElements = function getFeedbackElements() {
          if (!this.feedback) {
            ...
            var feedbackDelay =
              this.form.getAttribute(Attribute.FEEDBACK_DELAY) ||
        ...
        _proto.toggleSubmitButtonLoading = function toggleSubmitButtonLoading(
          loading
        ) {
        ...
        _proto.toggleSubmitButtonAnimation = function toggleSubmitButtonAnimation(
          animate
        ) {
        ...
        _proto.toggleSubmitButtonText = function toggleSubmitButtonText(
          loading
        ) {
        ...
        FormEmail.toggleDisabled = function toggleDisabled(elements, disabled) {
          mrUtil.forEach(elements, function(index, element) {
            ...
            if (
              !disabled &&
              !element.classList.contains(Selector.INITIALLY_DISABLED)
            ) {
  ...
  var mrIonRangeSlider = (function($) {
      ...
      (function() {
        ...
        _proto.handleChange = function handleChange(data) {
          if (this.fromElement && this.fromElement.length > 0) {
            mrIonRangeSlider.updateValue(
              this.fromElement,
              data.from_value || data.from
            );
          }
          ...
          if (this.unitElement && this.unitElement.length > 0) {
            ...
            mrIonRangeSlider.updateValue(
              this.unitElement,
              value > 1 ? this.options.unitPlural : this.options.unitSingle
            );
          }

          var userChangeFunction = mrUtil.getFuncFromString(
        ...
        _proto.setToUpdateEvent = function setToUpdateEvent(collection) {
          ...
          mrUtil.forEach(collection, function(index, element) {
            if (
              element.tagName.toUpperCase() === Selector.INPUT &&
    ...
    $(window).on(Event.LOAD_DATA_API, function() {
      var ionRangeSliderElements = $.makeArray(
        $(Selector.DATA_ION_RANGESLIDER)
      );
      /* eslint-disable no-plusplus */

      for (var i = ionRangeSliderElements.length; i--; ) {
        var $ionRangeSlider = $(ionRangeSliderElements[i]);
        IonRangeSlider.jQueryInterface.call(
          $ionRangeSlider,
          $ionRangeSlider.data()
        );
      }
  ...
  var mrIsotope = (function($) {
    ...
    function getCategoryFilter(filterBy) {
      return filterBy && filterBy !== Selector.FILTER_ALL
        ? "[" + Selector.CATEGORY + '*="' + filterBy + '"]'
        : Selector.FILTER_ALL;
    ...
    function getSorters(isotopeId) {
      return document.querySelectorAll(
        Selector.DATA_ISOTOPE_SORTERS +
          ...
          Selector.SORTER +
          "][" +
          Selector.PRIMARY_SORTER +
          "][" +
          Selector.SECOND_SORTER +
          "]"
      );
      ...
      (function() {
        ...
        _proto.initFilters = function initFilters() {
          ...
          var filters = getFilters(
            ...
            Selector.FILTER_INITIALISED
          );
          mrUtil.forEach(filters, function(index, filter) {
            var filterValue =
              filter.attributes[Selector.FILTER] &&
              filter.attributes[Selector.FILTER].value; // Find all other filters matching this value to be de/activated on click

            _this.filters[filterValue] = getFilter(
              _this.attributes.isotopeId,
              filterValue
            ...
            $(filter).on(Event.FILTER_CLICK, function(event) {
              ...
              _this.options.filter =
                filterValue === "*"
                  ? filterValue
                  : getCategoryFilter(filterValue); // Update isotope with current filter settings
        ...
        _proto.initSorters = function initSorters() {
          ...
          var defaultSort =
            this.attributes.defaultSort || Options.ORIGINAL_ORDER;
          mrUtil.forEach(sorters, function(index, sorter) {
            ...
            _this2.sorters[sortValue] = getSorter(
              _this2.attributes.isotopeId,
              sortValue
        ...
        _proto.initIsotope = function initIsotope() {
          ...
          hashFilter =
            hashFilter !== "" && !this.attributes.ignoreHash
              ? hashFilter
              : null; // Determine default filter

          var defaultFilter =
            hashFilter || this.attributes.defaultFilter || Selector.FILTER_ALL;
          ...
          this.options.layoutMode =
            this.attributes.layoutMode || Options.DEFAULT_LAYOUT;
          this.options.filter = defaultFilterSelector;
          this.options.sortAscending[
            Options.ORIGINAL_ORDER
          ] = defaultSortAscending;
          this.isotope = new Isotope$1(this.element, this.options);
          this.activeFilter = getFilter(
            this.attributes.isotopeId,
            defaultFilter
          );
  ...
  (function($) {
    if (typeof jarallax$1 === "function") {
      ...
      $(window).on("load", function() {
        ...
        var jarallaxDelay = document.querySelectorAll(
          "[data-jarallax-video-delay]"
        );
  ...
  var mrMaps = (function($) {
    ...
    Default.MAP.styles =
      typeof mrMapStyle !== typeof undefined ? mrMapStyle : undefined;
    /**
     * ------------------------------------------------------------------------
     * Class Definition
     * ------------------------------------------------------------------------
    ...
    var Map =
      ...
      (function() {
        ...
        _proto.geocodeAddress = function geocodeAddress(
          address,
          callback,
          thisMap,
          args
        ...
        _proto.createMarkers = function createMarkers() {
          ...
          Default.MARKER = {
            icon: {
              url:
                this.$element.attr(Selector.MARKER_IMAGE) ||
                Default.MARKER_IMAGE_URL,
          ...
          this.markerElements.each(function(index, marker) {
            ...
            markerAo.icon =
              typeof $marker.attr(Selector.MARKER_IMAGE) !== typeof undefined
                ? {
            ...
            if (infoWindow.length) {
              var gInfoWindow = new google.maps.InfoWindow({
                ...
                maxWidth: parseInt(
                  infoWindow.attr("data-max-width") || "250",
                  10
                )
              });
              ...
              if (/(-?\d+(\.\d+)?),\s*(-?\d+(\.\d+)?)/.test(markerLatLng)) {
                gMarker.setPosition(
                  new google.maps.LatLng(
                    parseFloat(
                      markerLatLng.substr(0, markerLatLng.indexOf(","))
                    ),
                    parseFloat(
                      markerLatLng.substr(markerLatLng.indexOf(",") + 1)
                    )
                  )
                );
      ...
      (function() {
        ...
        OverlayNav.getFirstOverlayElement = function getFirstOverlayElement() {
          return document.querySelector(
            Selector.OVERLAY_SECTION + ":not(" + Selector.NAV + ")"
          );
        };
  ...
  (function($) {
    ...
    $(container).on(Event.TOGGLE_SHOW + " " + Event.TOGGLE_HIDE, function(evt) {
      var action =
        evt.type + "." + evt.namespace === Event.TOGGLE_SHOW ? "add" : "remove";
  ...
  var mrReadingPosition = (function($) {
      ...
      (function() {
        ...
        _proto.initWatcher = function initWatcher(element) {
          ...
          watcher.stateChange(function() {
            ...
            _this.reading =
              watcher.isAboveViewport && watcher.isFullyInViewport;
        ...
        _proto.recalculatePercentage = function recalculatePercentage(
          scrollPosition
        ) {
          this.articlePositionPercent = !scrollPosition
            ? 0
    ...
    $(window).on(Event.LOAD_DATA_API, function() {
      ...
      var readingPositionElements = $.makeArray(
        $(Selector.DATA_READING_POSITION)
      );
      /* eslint-disable no-plusplus */

      for (var i = readingPositionElements.length; i--; ) {
        var $readingPosition = $(readingPositionElements[i]);
        ReadingPosition.jQueryInterface.call(
          $readingPosition,
  ...
  */
  ...
  svgInjector.SVGInjector(document.querySelectorAll("[data-inject-svg]"), {
    afterEach: function afterEach(err, svg) {
      if (typeof jarallax === "function") {
        svg.dispatchEvent(
          new CustomEvent("injected.mr.SVGInjector", {
            bubbles: true
          })
        );
      }
  ...
  var mrTwitterFetcher = (function($) {
    ...
    var TwitterFetcher =
      ...
      (function() {
        function TwitterFetcher(element) {
          ...
          this.username =
            $element.data(Options.USERNAME).replace("@", "") ||
            Defaults.USERNAME;
          this.maxTweets =
            parseInt($element.data(Options.MAX_TWEETS), 10) ||
            Defaults.MAX_TWEETS; // Check if data-twitter-slider is options object, plain attribute or not present.

          this.slider =
            this.element.getAttribute(
              Selector.DATA_TWITTER + "-" + Options.FLICKITY
            ) !== null;
          this.slider =
            this.slider && typeof $element.data(Options.SLIDER) === "object"
              ? $element.data(Options.SLIDER)
              : this.slider; // Check if data-twitter-isotope is present.

          this.isotope =
            this.element.getAttribute(
              Selector.DATA_TWITTER + "-" + Options.ISOTOPE
            ) !== null;
            ...
            customCallback: function customCallback(tweets) {
              ...
              if (_this.slider === true || typeof _this.slider === "object") {
                ...
                if (typeof Flickity === "undefined") {
                  ...
                  $element.data(
                    "flickity",
                    new Flickity(_this.element, _this.slider)
                  );
                }
    ...
    $(window).on(Event.LOAD_DATA_API, function() {
      var twitterFetcherElements = $.makeArray(
        $(Selector.DATA_TWITTER_FETCHER)
      );
      /* eslint-disable no-plusplus */

      for (var i = twitterFetcherElements.length; i--; ) {
        var $twitterFetcher = $(twitterFetcherElements[i]);
        TwitterFetcher.jQueryInterface.call(
          $twitterFetcher,
          $twitterFetcher.data()
        );
      }
